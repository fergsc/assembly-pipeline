...
if os.path.isfile("{}.genes".format(refSpecies)) == False:
    print ("{}.genes doesn't not exist".format(refSpecies))
    print("awk -v OFS='\\t' '{if($3 == \"gene\"){split($9,a,\";\"); if($4<$5){print $1,$4,$5,a[1]} else {print $1,$5,$4,a[1]}}}' XXX.gtf > XXX.genes")
    exit()

if os.path.isfile("{}.genes".format(qrySpecies)) == False:
    print ("{}.genes doesn't not exist".format(qrySpecies))
    print("awk -v OFS='\\t' '{if($3 == \"gene\"){split($9,a,\";\"); if($4<$5){print $1,$4,$5,a[1]} else {print $1,$5,$4,a[1]}}}' XXX.gtf > XXX.genes")
    exit()
...
#
#open files
tsv_file = open(syriFile)
syriFile = csv.reader(tsv_file, delimiter="\t")

refGenes = loadGenes("{}.genes".format(refSpecies))
qryGenes = loadGenes("{}.genes".format(qrySpecies))
